...
@Component
@FxmlView("/ui/PediatriciansPage.fxml")
public class PediatricianPageController implements Initializable {
    ...
    void loadDoctorDetails(){
        ...
        doctorList.addAll(doctorService.findByMedicalField("Pediatrician"));
