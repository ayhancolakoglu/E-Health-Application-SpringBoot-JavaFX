...
@Component
@FxmlView("/ui/GynecologistPage.fxml")
public class GynecologistPageController implements Initializable {
    ...
    void loadDoctorDetails() {
        ...
        doctorList.addAll(doctorService.findByMedicalField("Gynecologist"));
